...
public class JWTTools {
    ...
    public String createToken(User user) {
        return Jwts.builder()
                .subject(String.valueOf(user.getIdUser())) // stringhifizzo l'uuid per settarlo come subject
    ...
    public void verifyToken(String token) {
        try {
            ...
            throw new UnauthorizedException("Ci sono stati problemi con il Token, rieffettua il Login!");
        }
    }
